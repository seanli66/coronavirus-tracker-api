...
class Location_Builder(Builder):
    ...
    def build_base(self) -> None:
        self._location.set_base
    def build_stat(self) -> None:
        self._location.set_statistic
    def build_geo(self) -> None:
        self._location.set_geoinfo
...
class TimelinedLocation_Builder(Builder):
    ...
    def reset(self) -> None:
        self._timelinedlocation = TimelinedLocation()
    ...
    def build_base(self) -> None:
        self._timelinedlocation.set_base
    def build_stat(self) -> None:
        self._timelinedlocation.set_statistic
    def build_geo(self) -> None:
        self._timelinedlocation.set_geoinfo
    def build_timelines(self) -> None:
        self._timelinedlocation._timelines
